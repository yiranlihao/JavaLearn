...
public class JsonUtil {
	...
	public static Map<String, String> jsonStringToList(String rsContent)
		...
		JSONObject jsonObject = new JSONObject(rsContent);// 将String串转为jsonObject
		Map result = new HashMap();
		Iterator iterator = jsonObject.keys();// jsonObject.keys()只能获取json的第一层key，然后将key和对应的value封装进map对象
		String key = null;
		String value = null;
